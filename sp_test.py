...
for item in networkr:
    ...
    row_cells[6].text = route[6]
    row_cells[7].text = route[7]
...
for item in servicep:
    sevp = item.split()
    row_cells = table.add_row().cells
    row_cells[0].text = sevp[0]
    row_cells[1].text = sevp[1]
    row_cells[2].text = sevp[2]
    row_cells[3].text = sevp[3]
    row_cells[4].text = sevp[4]
    row_cells[5].text = sevp[5]
    row_cells[6].text = sevp[6]
...
for item in tss1:
    ...
    #row_cells[4].text = tss2[4]
    if tss2[4] == 'Compliance':
        #row_cells[4].paragraphs[0].add_run(tss2[4]).font.color.rgb =  RGBColor(0, 255, 0)
        row_cells[4].paragraphs[0].add_run(tss2[4]).bold = True
        row_cells[4]._tc.get_or_add_tcPr().append(Green)
    else:
        #row_cells[4].paragraphs[0].add_run(tss2[4]).font.color.rgb =  RGBColor(255, 0, 0)
        row_cells[4].paragraphs[0].add_run(tss2[4]).bold = True
...
for item in riska:
    ...
    #row_cells[3].text = rka[3]
    if rka[3] == 'No-Risk':
        #row_cells[3].paragraphs[0].add_run(rka[3]).font.color.rgb =  RGBColor(0, 255, 0)
        row_cells[3].paragraphs[0].add_run(rka[3]).bold = True
        row_cells[3]._tc.get_or_add_tcPr().append(Green)
    elif rka[3] == 'MID-Risk':
        #row_cells[3].paragraphs[0].add_run(rka[3]).font.color.rgb =  RGBColor(255, 140, 0)
        row_cells[3].paragraphs[0].add_run(rka[3]).bold = True
        row_cells[3]._tc.get_or_add_tcPr().append(Orange)
    else:
        #row_cells[3].paragraphs[0].add_run(rka[3]).font.color.rgb =  RGBColor(255, 0, 0)
        row_cells[3].paragraphs[0].add_run(rka[3]).bold = True
